...
class ModelDetilNilai extends Model
{
    ...
    {
        $this->select("siswa.nis as nis, siswa.nama as nama, siswa.jenis_kelamin_id_jk as gender, detil_nilai.nilai as nilai");
        ...
        $this->join("tugas", "ampu_mapel.id_ampu = tugas.ampu_mapel_id_ampu");
        $this->join("mata_pelajaran", "ampu_mapel.id_ampu = mata_pelajaran.id_mapel");
