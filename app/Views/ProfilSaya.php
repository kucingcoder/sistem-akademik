...
<?= $this->section('Judul') ?>SMK Bahari Tegal - Profil Saya<?= $this->endSection() ?>
<?= $this->section('Menu') ?>profil-saya<?= $this->endSection() ?>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-2" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <h5 class="card-title">Profil Saya <span>| <?php echo $Nama; ?></span></h5>
                            <form class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" value="<?php echo $Profil["nama_lengkap"]; ?>" id="NamaLengkap" disabled="true">
                                </div>
                ...
                <div class="card-body">
                    <div class="activity">
                        <?php if (!empty($Dokumen)) : ?>
                            <h5 class="card-title">Dokumentasi Saya <span>| <?php echo count($Dokumen); ?> dokumen</span></h5>
                        ...
                        <?php else : ?>
                            <h5 class="card-title">Dokumentasi Saya <span>| kosong</span></h5>
                        <?php endif; ?>
...
<script>
    ...
    function DeskripsiKelas(id_kelas) {
        ...
        fetch("/profil/deskripsi-kelas?id=" + id_kelas)
            .then(response => {
                if (!response.ok) {
    ...
    function UbahUsernamePassword() {
        ...
        fetch("/profil/ubah-username-password", {
                method: 'POST',
                headers: {
    ...
    function InfoDokumen(id) {
        ...
        fetch("/profil/info-dokumen?id=" + id)
            .then(response => {
                if (!response.ok) {
                    throw new Error('Network response was not ok');
                }
